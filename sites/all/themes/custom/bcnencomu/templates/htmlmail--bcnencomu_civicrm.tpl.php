 ...
 */
  ...
  $images_url = $base_url . '/' . drupal_get_path('theme', 'bcnencomu') . '/img/email/';
?>
<?php include($template_path . '/email-header.tpl.php') ?>
<?php echo $body; ?>
<?php include($template_path . '/email-footer.tpl.php') ?>
