...
<!--[if gt IE 8]><!--> <html class="no-js" xml:lang="<?php print $language->language; ?>" lang="<?php print $language->language; ?>" dir="<?php print $language->dir; ?>" <?php //print $rdf_namespaces; ?>> <!--<![endif]-->
  <head>
    ...
    <link href="//fonts.googleapis.com/css?family=Roboto:400,300,100,400italic,500,500italic,700,700italic,900&subset=latin,latin-ext" rel="stylesheet">
    <?php print $styles; ?>
    <!--[if lt IE 9]>
