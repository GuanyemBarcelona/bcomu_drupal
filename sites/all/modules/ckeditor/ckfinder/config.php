...
function CheckAuthentication()
{
    ...
    $drupal_path = "/home/bcnencomu/webs/drupal/";
    if(file_exists($drupal_path . "includes/bootstrap.inc")) {
		  ...
		  if (!isset($user->session['authenticated'])) {
		    $user->session['authenticated'] = '';
		  }
		  
		  $user->session['authenticated'] = false;
		  if (isset($user->roles) && is_array($user->roles) && !isset($user->roles[1])) {
...
*/
$baseUrl = 'https://barcelonaencomu.cat/sites/default/files/';
...
ATTENTION: The trailing slash is required.
*/
$baseDir = '/home/bcnencomu/webs/drupal/sites/default/files/';
